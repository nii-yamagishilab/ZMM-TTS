...
def get_codebook_indices_lists(data_dir):
    ...
    for wav_name in filelist:
      if wav_name.endswith('wav'):
        ...
        np.save(os.path.join('/home/others/v-cheng-gong/Low_resources_languages/Dataset/CP/fr/DiscreteRpw2v',wav_name[:-3]+'npy'), org_quan)
        np.save(os.path.join('/home/others/v-cheng-gong/Low_resources_languages/Dataset/CP/fr/CodeIndexw2v',wav_name[:-3]+'npy'), index)
