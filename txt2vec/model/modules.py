    ...
    def __init__(self, preprocess_config, model_config, train_config, d_model):
        ...
        if model_config["duration_modeling"]["learn_alignment"]:
            ...
            self.aligner = AlignmentEncoder(
                n_mel_channels=preprocess_config["preprocessing"]["mel"]["n_mel_proj"],
                n_att_channels=preprocess_config["preprocessing"]["mel"]["n_mel_proj"],
                n_text_channels=d_model+temp,
